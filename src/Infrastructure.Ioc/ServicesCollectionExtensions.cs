...
namespace Infrastructure.CrossCutting.Ioc
{
    public static class ServicesCollectionExtensions
    {
        ...
        public static IServiceCollection AddServices(this IServiceCollection servicesCollection)
        {
            ...
            servicesCollection.TryAddScoped<IVideoService, VideoService>();
            ...
            servicesCollection.TryAddScoped<IUploadService, BlobStorageService>();
        ...
        public static IServiceCollection AddRepositories(this IServiceCollection servicesCollection)
        {
            ...
            servicesCollection.TryAddScoped<IVideoRepository, VideoRepository>();

            return servicesCollection;
        }

        public static IServiceCollection AddAzureBlobStorage(this IServiceCollection servicesCollection, IConfiguration config)
        {
            servicesCollection.AddAzureClients(clientbuilder =>
            {
                clientbuilder.AddBlobServiceClient(config.GetSection("AzureStorage:ConnectionString").Value);
            });
